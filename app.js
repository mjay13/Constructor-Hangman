...
// 2. Feel free to use as many different types of constructor functions as you are able to, 
...
// 3. You must keep track of the user's remaining guesses and prompt the user 
		// if they would like to end the game if none remain.
